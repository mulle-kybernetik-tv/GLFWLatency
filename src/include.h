#ifndef glfwlatency_include_h__
#define glfwlatency_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "GLFWLatency-include.h" to keep the #include statements in the
...
#include "_GLFWLatency-include.h"
